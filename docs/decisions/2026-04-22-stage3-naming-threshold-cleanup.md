...
**Status**: Accepted (Partial — HY OAS 임계 결정 보류)  
**Date**: 2026-04-22  
**Stage**: 3 — PR #13  
**Related PR**: PR #13
...
> **보고**: 현재 코드의 HY OAS 임계(3.5/5.0/7.0%)가 v1.0 원문(3.0/4.0/5.5%)보다 완화.  
> TW 결정 전까지 현행 유지.

TW 선택지:
- A) v1.0 원문(3.0/4.0/5.5%)으로 되돌리기 (더 보수적, PR별도 소규모)
- B) 현행(3.5/5.0/7.0%) 유지 (GFC 데이터 기반 조정값으로 인정)
...
**부정적 / 주의:**
- HY OAS 임계 결정 보류 → TW 확인 후 별도 소규모 수정 또는 현행 유지
